...
" Will delete all [No Name] buffers
" if [No Name] is in the only window, it will keep, why not just close the window also?
...
" Will maintain current opened [No Name] buffer
